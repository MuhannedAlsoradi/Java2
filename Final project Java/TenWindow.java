...
class TenWindow extends JFrame implements ActionListener {
    ...
    JLabel label8 = new JLabel("Rollno:");
    ...
    JButton button1 = new JButton("Load Record");
    JButton button2 = new JButton("Update Student");
    ...
    public TenWindow() {
        ...
        textField7.setBounds(120, 10, 150, 20);
        comboBox.setBounds(120, 220, 150, 20);
        button2.setBounds(200, 470, 150, 20);
        button3.setBounds(225, 500, 100, 20);
        button1.setBounds(300, 10, 150, 20);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == button1) {
            for (int i = 0; i < UserClass.list2.size(); i++) {
                if (textField1.getText().equals(UserClass.list2.get(i)[0])) {
                    textField2.setText(UserClass.list2.get(i)[1]);
                    textField3.setText(UserClass.list2.get(i)[2]);
                    textField4.setText(UserClass.list2.get(i)[3]);
                    textField5.setText(UserClass.list2.get(i)[4]);
                    textField6.setText(UserClass.list2.get(i)[5]);
                    textField7.setText(UserClass.list2.get(i)[6]);
                    textField1.setText("hh");
                    comboBox.setSelectedItem(UserClass.list2.get(i)[7]);
                    break;
                } else {
